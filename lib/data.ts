...
export const skills = [
  ...
  {
    category: "Cloud & Data",
    items: ["AWS S3", "AWS Athena", "AWS SageMaker"],
  },
  {
    category: "Methods",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      "Spatial analysis",
      "DisPerSE / persistent homology",
    ],
  },
];

export const contact = {
  email: "filippo.guastella01@gmail.com",
  github: "https://github.com/filippo-creator",
  linkedin: "https://www.linkedin.com/in/filippo-guastella",
};
